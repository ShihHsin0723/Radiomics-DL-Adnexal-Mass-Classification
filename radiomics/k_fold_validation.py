...
class MultiChannelDataset(Dataset):
    def __init__(self, image_paths, radiomics_dir, feature_map1, feature_map2, transform=None):
        ...
        for img_path in image_paths:
            ...
            img_base_name = os.path.basename(img_path).rsplit('_', 1)[0] 
...
if __name__ == "__main__":
    ...
    # Define paths
    image_dir = "/home/phoebe0723/rop2/all_data/merged"
    ...
    results_df.to_csv("radiomics_kfold_results_new_split.csv", index=False)